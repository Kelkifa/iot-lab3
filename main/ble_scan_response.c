...
static uint8_t service_data[6] = {0xE5, 0x02, 0x01, 0x01, 0x01, 0x01};
...
static void esp_gap_cb(esp_gap_ble_cb_event_t event, esp_ble_gap_cb_param_t *param)
{
	...
	case ESP_GAP_BLE_ADV_DATA_SET_COMPLETE_EVT:
		...
		// case ESP_GAP_BLE_ADV_DATA_RAW_SET_COMPLETE_EVT: //raw
	...
	case ESP_GAP_BLE_SCAN_RSP_DATA_SET_COMPLETE_EVT: //response event
		...
		// case ESP_GAP_BLE_SCAN_RSP_DATA_RAW_SET_COMPLETE_EVT: //raw
	...
	case ESP_GAP_BLE_ADV_START_COMPLETE_EVT: //response event
